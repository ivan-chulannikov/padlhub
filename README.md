...
- Клавиатурная навигация, focus management модального окна и доступные состояния фильтров.
- Базовые SEO, Open Graph и color-scheme метаданные.
...
Интерактивное описание запросов, параметров, ответов и ошибок доступно в Swagger UI по адресу `GET /api/docs`.
...
Полный локальный quality gate frontend и backend запускается одной командой:
